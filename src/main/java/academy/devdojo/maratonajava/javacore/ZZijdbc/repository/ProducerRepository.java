...
public class ProducerRepository {
    ...
    public static void saveTransaction(List<Producer> producers) {
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            log.error("Error while trying to saving producer '{}'", producers, e);
        }
    }
...
//                if (p.getName().equals("White fox")) throw new SQLException("Can´t save white fox");
    ...
    public static List<Producer> findByName(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to finf all producers ", e);
        }
        return producers;
    }
    ...
    public static void showProducerMetaData() {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            for (int i = 1; i <= columnCount; i++) {
                ...
                log.info("Clumn name '{}", rsMetaData.getColumnName(i));
                log.info("Clumn size '{}", rsMetaData.getColumnDisplaySize(i));
                log.info("Clumn type '{}", rsMetaData.getColumnTypeName(i));
